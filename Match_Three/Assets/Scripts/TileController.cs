...
public class TileController : MonoBehaviour
{
    ...
    private List<TileController> GetOneLineMatches(Vector2[] paths) {
        List<TileController> matchingTiles = new List<TileController>();
    ...
    public List<TileController> GetAllMatches() {
        ...
        List<TileController> horizontalMatchingTiles = GetOneLineMatches(new Vector2[2] { Vector2.up, Vector2.down});
        List<TileController> verticalMatchingTiles = GetOneLineMatches(new Vector2[2] { Vector2.left, Vector2.right });
